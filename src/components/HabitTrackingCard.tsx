  ...
  if (isLoading) {
    return (
      <motion.div
        ...
        className="bg-gray-500/[0.02] backdrop-blur-[4.6px] rounded-2xl p-3 shadow-[0_4px_30px_rgba(0,0,0,0.1)] border-2 border-transparent hover:border-orange-400/50 hover:shadow-orange-500/30 transition-all duration-300"
      >
